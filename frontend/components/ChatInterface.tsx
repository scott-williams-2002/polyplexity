...
export const ChatInterface: React.FC<ChatInterfaceProps> = ({ messages, isGenerating }) => {
  ...
  return (
    <div className="flex-1 overflow-y-auto overflow-x-hidden px-2 md:px-4 py-8 scroll-smooth w-full max-w-[100vw] box-border">
      <div className="max-w-full md:max-w-4xl mx-auto min-h-full w-full box-border">
