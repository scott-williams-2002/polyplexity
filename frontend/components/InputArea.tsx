...
export const InputArea: React.FC<InputAreaProps> = ({ onSend, disabled }) => {
  ...
  return (
    <div className="sticky bottom-0 bg-background/80 backdrop-blur-md border-t border-border/50 pb-6 pt-2 px-2 md:px-4 z-50 w-full max-w-[100vw] overflow-x-hidden box-border">
      <div className="max-w-[calc(100vw-1rem)] md:max-w-4xl mx-auto relative w-full box-border">
        <div className={cn(
